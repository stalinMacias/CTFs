...
async function main() {
  ...
  const ProxyContractAddress = await this.puzzleWalletFactory.ProxyContract();  // PuzzleProxy
  const LogicContractAddress = await this.puzzleWalletFactory.LogicContract();  // PuzzleWallet
