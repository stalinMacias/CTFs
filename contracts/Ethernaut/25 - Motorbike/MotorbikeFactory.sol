...
contract MotorbikeFactory is Level {
  ...
  address public MotorbikeContract;
  address public EngineContract;

  function createInstance(address _player) public payable override {
    _player;
    ...
    MotorbikeContract = address(motorbike);
    EngineContract = address(engine);
